const radicalMap = {
    "꒐": {
        ...
        name_trans: "QOT",
        syllables: [
            [1, ["yy", "yyx", "pu", "pux", "xy", "xyx", "nzy", "nzyx"]],
            [2, ["nbiep", "bbi", "bbix", "nyot", "kut", "ddu", "ddux", "hly", "hlyx", "nyup", "jjur", "jjurx", "ndu", "ndux", "bbot", "a", "ax", "fo", "fox", "zzyp", "shyt", "bi", "bix", "pat", "nbup", "xyr", "xyrx"]],
            [3, ["qot", "nzip", "zhe", "zhex", "myp", "hmi", "hmix", "zhy", "zhyx", "hxe", "hxex", "shut", "lyt", "huop", "jju", "jjux", "ddip", "dit", "jji", "jjix", "nry", "nryx", "nbap", "nrap", "nyu", "nyux", "ba", "bax", "bat", "ruop", "nryp", "nzyt", "ddup"]],
            [4, ["gge", "ggex", "uo", "uox", "quo", "quox", "bap", "fu", "fux", "zit", "ddiep", "mguo", "mguox", "hla", "hlax", "bbo", "bbox", "rur", "rurx", "fop"]],
            [5, ["lat", "ssyt", "ddie", "ddiex", "vyr", "vyrx", "zie", "ziex", "yyr", "yyrx", "rut", "vie", "viex"]]
        ],
        radical_chars: ["qot="]
    },
    "꒑": {
        ...
        syllables: [
            ...
            [4, ["hmu", "hmux", "te", "tex", "rruo", "rruox", "rrot", "tuop", "fat", "shap", "nyie", "nyiex"]],
    ...
    "꒓": {
        ...
        name_trans: "NYIP",
        syllables: [
            [1, ["nyip", "ci", "cix", "kop", "la", "lax", "hit", "ggie", "ggiex"]],
            [2, ["suo", "suox", "suop", "sip", "hxep", "huo", "huox", "hmap", "dur", "durx", "hni", "hnix", "tep", "mo", "mox", "cha", "chax", "chat", "zhuo", "zhuox", "zhot", "hnip", "rat", "jyt", "wep", "luo", "luox", "zzu", "zzux", "ie", "iex", "ciep", "cit", "xo", "xox", "ssop", "he", "hex", "rrut", "ruo", "ruox", "ciet", "mgie", "mgiex", "rryp", "zhu", "zhux"]],
    ...
    "꒔": {
        ...
        syllables: [
            [0, ["cyp"]],
            [1, ["ge", "gex", "hxo", "hxox", "sse", "ssex", "nuo", "nuox", "dop", "lo", "lox", "ggot", "by", "byx", "hie", "hiex", "cuo", "cuox"]],
    ...
    "꒕": {
        ...
        name_trans: "SSI",
        syllables: [
            [1, ["at", "tip", "hna", "hnax", "ggut", "kie", "kiex", "nzop", "nzox"]],
    ...
    "꒗": {
        ...
        vars: ["꒘"],
        syllables: [
            [1, ["gep", "di", "dix", "do", "dox", "mi", "mix"]],
            [2, ["hlut", "bbup", "nep", "nop", "fip", "nda", "ndax", "get", "ndat", "cup", "njyr", "njyrx", "na", "nax", "ssy", "ssyx", "hlyr", "hlyrx", "mip", "miep", "hmuop", "yut", "nbyp", "njur", "njurx"]],
    ...
    "꒙": {
        ...
        syllables: [
            ...
            [3, ["zziep", "ddit", "shuop", "fa", "fax", "zzit", "vip", "bbe", "bbex"]],
            [4, ["ndit", "fap", "ssie", "ssiex", "jjyt", "ssiep"]],
            [5, ["zha", "zhax"]]
        ],
        radical_chars: ["hxit="]
    },
    ...
    "꒜": {
        ...
        syllables: [
            ...
            [2, ["nro", "nrox", "git", "cap", "nbut", "nbot", "zhap", "chur", "churx"]],
    ...
    "꒟": {
        ...
        syllables: [
            [0, ["hxuo", "hxuox"]],
            [1, ["bup", "ju", "jux", "vi", "vix", "hxie", "hxiex", "ngot", "tat", "rre", "rrex", "hxot", "jy", "jyx"]],
            [2, ["die", "diex", "dde", "ddex", "njop", "rrur", "rrurx", "jjop", "rup", "jyp", "zhyr", "zhyrx", "shot", "njup", "bbiep"]],
            [3, ["nju", "njux", "mgu", "mgux", "vu", "vux", "jiep", "hluo", "hluox", "hne", "hnex", "tap", "kat", "wuo", "wuox", "bbie", "bbiex"]],
            [4, ["shyr", "shyrx", "nyiep", "nyiet", "bbat", "hnep", "rrup", "pop"]],
            [5, ["puo", "puox", "mge", "mgex", "jjuo", "jjuox"]]
        ],
    ...
    "꒡": {
        ...
        syllables: [
            ...
            [4, ["jjiep", "jjit", "yyt", "nzuo", "nzuox", "sho", "shox"]],
    ...
    "꒤": {
        ...
        syllables: [
            ...
            [2, ["it", "i", "ix", "nzur", "nzurx", "pa", "pax", "pap", "luop", "cot", "wat", "bur", "burx", "jjie", "jjiex"]],
    ...
    "꒨": {
        ...
        syllables: [
            [0, ["tu", "tux"]],
            [1, ["qip", "hlep", "qu", "qux", "ho", "hox", "ca", "cax", "ce", "cex", "hle", "hlex"]],
            [2, ["qur", "qurx", "vat", "sso", "ssox", "lip", "nyut", "gap", "gup", "jut", "ssep", "cat"]],
            [3, ["lut", "qop", "nrat", "bo", "box", "mit", "mie", "miex"]],
            [4, ["guop", "nzyp", "hmip"]],
            [5, ["hmup"]]
        ],
        radical_chars: ["tu="]
    ...
    "꒪": {
        ...
        syllables: [
            ...
            [3, ["ndup", "re", "rex", "tup", "hlie", "hliex", "ssap", "hlup", "hap", "mgot", "nbi", "nbix"]],
    ...
    "꒬": {
        ...
        syllables: [
            [0, ["pyt"]],
            [1, ["mot", "hmot", "nip", "ip", "nde", "ndex"]],
            [2, ["pyr", "pyrx", "zzi", "zzix", "pit", "jjip", "ddep", "nrep", "qit", "hxat", "yit", "yiet", "vur", "vurx"]],
            [3, ["hmo", "hmox"]],
            [4, ["nit"]],
            [5, ["byr", "byrx"]]
        ],
    ...
    "꒳": {
        ...
        syllables: [
            ...
            [4, ["njiet", "ssat", "nzu", "nzux", "got", "ssyr", "ssyrx"]],
            [5, ["nzup"]]
        ],
    ...
    "꒾": {
        ...
        syllables: [
            [0, ["cip", "hxop"]],
            [1, ["hmut", "py", "pyx", "kiep", "njo", "njox"]],
            [2, ["kip", "ddut", "hxi", "hxix", "nbyr", "nbyrx"]],
            [3, ["qiet", "njot", "qyr", "qyrx"]]
        ],
    ...
    "꓀": {
        ...
        syllables: [
            ...
            [2, ["ggu", "ggux", "bba", "bbax", "ggup", "guo", "guox", "zur", "zurx", "che", "chex", "chep", "nguo", "nguox"]],
            [3, ["chuop", "cu", "cux", "chet"]]
        ],
